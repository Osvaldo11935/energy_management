...
public class TabelaGerador {
        ...
        public static JPanel criarTabelaComAcoes(
                        String[] colunas,
                        List<Object[]> dados,
                        List<AcaoTabela> opcoes,
                        String textoBotaoNovo,
                        AcaoNovo acaoNovo) {
                ...
                lblPesquisa.setFont(
                                lblPesquisa.getFont().deriveFont(16f));

                JTextField txtPesquisa = new JTextField();

                txtPesquisa.setPreferredSize(
                                new Dimension(
                                                250,
                                                35));
                ...
                btnNovo.setFont(
                                btnNovo.getFont().deriveFont(Font.BOLD));
                ...
                tabela.getTableHeader().setFont(
                                tabela.getFont().deriveFont(Font.BOLD));
                ...
                TableColumn coluna = tabela
                                .getColumnModel()
                                .getColumn(
                                                colunaAcoes);

                coluna.setPreferredWidth(
                                60);

                coluna.setMaxWidth(80);
                coluna.setMinWidth(50);

                coluna.setCellRenderer(
                                new MenuRenderer());

                coluna.setCellEditor(
                                new MenuEditor(
                                                tabela,
                                                opcoes));
