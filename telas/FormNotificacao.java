...
public class FormNotificacao extends JPanel {
    ...
    public FormNotificacao(NotificacaoModelo dadosNotificacao) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new FormNotificacao().setVisible(true));
    }
}