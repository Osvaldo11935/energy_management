...
public class PessoaModelo  extends BaseModelo {
    ...
    @CampoFormulario(descricao = "Nome do Pai", obrigatorio = true, largura = 200, linha = 3)
    private StringBufferModelo nomePai;

    @CampoFormulario(descricao = "Nome da Mãe", obrigatorio = true, largura = 200, linha = 3)
    ...
    @CampoFormulario(
            ...
            obrigatorio = true,
            tipo = TipoCampo.COMBO,
            enumType = Genero.class,
            largura = 94,
            linha = 4
    )
    private StringBufferModelo genero;

    @CampoFormulario(descricao = "Residência", obrigatorio = true, largura = 200, linha = 5)
    private StringBufferModelo residencia;

    @CampoFormulario(descricao = "Naturalidade", obrigatorio = true, largura = 200, linha = 5)
