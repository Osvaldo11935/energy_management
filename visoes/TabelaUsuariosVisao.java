...
public class TabelaUsuariosVisao extends JFrame {
  ...
  private void carregarTabela() {
    ...
    List < Object[] > dados = usuarios.stream().map(u -> new Object[] {
      u.getId(),
      u.getNomeUsuario(),
      u.getEmail(),
      u.getNumeroTelefone(),
    ...
    colunas, dados, criarAcoes(), "Novo", this::abrirNovoUsuario);
  ...
  private List < TabelaGerador.AcaoTabela > criarAcoes() {
    ...
    return List.of(
    new TabelaGerador.AcaoTabela() {@Override
      ...
      int linha, Object[] dadosLinha) {
        ...
        FormWindow tela = new FormWindow("Atualizar Usuário", 456, 387, new FormUsuarioVisao(usuario));
    ...
    new TabelaGerador.AcaoTabela() {
      ...
      int linha, Object[] dadosLinha) {
        ...
        TabelaUsuariosVisao.this, "Remover " + dadosLinha[1] + "?", "Confirmação", JOptionPane.YES_NO_OPTION);
        ...
        if (confirm == JOptionPane.YES_OPTION) {
          ...
          TabelaUsuariosVisao.this, "Removido!");
        }
      }
    },
    new TabelaGerador.AcaoTabela() {@Override
      ...
      public void executar(int linha, Object[] dadosLinha) {
        ...
        int id = getId(dadosLinha);
        SwingUtilities.invokeLater(() -> new DetalheUsuarioVisao(() -> String.valueOf(id)).setVisible(true));
      }
    });
  }
  ...
  private void abrirNovoUsuario() {
    FormWizardVisao tela = new FormWizardVisao();
    tela.addWindowListener(
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(() -> new TabelaUsuariosVisao().setVisible(true));
  }
}