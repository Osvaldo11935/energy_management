...
public class FormSubestacaoVisao extends JPanel {
    public FormSubestacaoVisao() {
    ...
    public FormSubestacaoVisao(SubestacaoModelo dadosSubestacao) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new FormSubestacaoVisao().setVisible(true));
    }
}