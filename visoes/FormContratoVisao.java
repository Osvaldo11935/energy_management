...
public class FormContratoVisao extends JFrame {
    ...
    public FormContratoVisao(int usuarioId) {
        ...
        painelCards.add(new FormClienteVisao(() -> Integer.toString(usuarioId) ,  id -> {
            clienteId = id;
    ...
    private void configurarProximosPassos() {
        ...
        if (usuario.ehCliente()) {
            painelCards.add(new FormContadorVisao(() -> clienteId),"PASSO_2");
            totalPassos = 2;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() ->new FormContratoVisao(1).setVisible(true));
    }
}