...
public class TabelaNotificacaoVisao extends JFrame {
  ...
  private void carregarTabela() {
    ...
    colunas, dados, criarAcoes(), "Novo", this::abrirNovoNotificacao);
  ...
  private List < TabelaGerador.AcaoTabela > criarAcoes() {
    ...
    acoes.add(new TabelaGerador.AcaoTabela() {@Override
      public void executar(int linha, Object[] dadosLinha) {
        ...
        FormWindow tela = new FormWindow("Atualizar Notificacao", 456, 348, new FormNotificacaoVisao(Notificacao));
    ...
    acoes.add(new TabelaGerador.AcaoTabela() {@Override
      public void executar(int linha, Object[] dadosLinha) {
        ...
        TabelaNotificacaoVisao.this, "Remover " + dadosLinha[1] + "?", "Confirmação", JOptionPane.YES_NO_OPTION);
        ...
        if (confirm == JOptionPane.YES_OPTION) {
          ...
          JOptionPane.showMessageDialog(TabelaNotificacaoVisao.this, "Removido!");
        }
      }
  ...
  Object[] dadosLinha) {
    ...
    int id = getId(dadosLinha);
    return Notificacaos.stream().filter(p -> p.getId() == id).findFirst().orElse(null);
  }
  ...
  private void abrirNovoNotificacao() {
    ...
    FormWindow tela = new FormWindow("Nova Notificacao", 456, 478, new FormNotificacaoVisao());
  ...
  public static void main(String[] args) {
    SwingUtilities.invokeLater(() -> new TabelaNotificacaoVisao().setVisible(true));
  }
}