...
public class FormContadorVisao extends JPanel {
    private Supplier<String> idClienteProvider;
    public FormContadorVisao(Supplier<String> idClienteProvider) {
    ...
    public FormContadorVisao(ContadorModelo dadosContador) {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new FormContadorVisao(()-> "").setVisible(true));
    }
}