...
public class TabelaPerfilVisao extends JFrame {

  private final PerfilFile arquivo = new PerfilFile(new PerfilModelo());

  private List < PerfilModelo > perfis;

  private JPanel painelTabela;

  public TabelaPerfilVisao() {
  ...
  private void carregarTabela() {
    ...
    colunas, dados, criarAcoes(), "Novo", this::abrirNovoPerfil);
  ...
  private List < TabelaGerador.AcaoTabela > criarAcoes() {
    ...
    acoes.add(new TabelaGerador.AcaoTabela() {@Override
      public void executar(int linha, Object[] dadosLinha) {
        ...
        FormWindow tela = new FormWindow("Atualizar Perfil", 300, 300, new FormPerfilVisao(perfil));
    ...
    acoes.add(new TabelaGerador.AcaoTabela() {@Override
      public void executar(int linha, Object[] dadosLinha) {
        ...
        TabelaPerfilVisao.this, "Remover " + dadosLinha[1] + "?", "Confirmação", JOptionPane.YES_NO_OPTION);
        ...
        if (confirm == JOptionPane.YES_OPTION) {
          ...
          JOptionPane.showMessageDialog(TabelaPerfilVisao.this, "Removido!");
        }
      }
  ...
  Object[] dadosLinha) {
    ...
    int id = getId(dadosLinha);
    return perfis.stream().filter(p -> p.getId() == id).findFirst().orElse(null);
  }
  ...
  private void abrirNovoPerfil() {
    ...
    FormWindow tela = new FormWindow("Atualizar Perfil", 300, 300, new FormPerfilVisao());
  ...
  public static void main(String[] args) {
    SwingUtilities.invokeLater(() -> new TabelaPerfilVisao().setVisible(true));
  }
}