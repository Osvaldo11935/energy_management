...
public class TabelaFaturaVisao extends JFrame {
  ...
  public TabelaFaturaVisao(int clienteId) {
  ...
  private void carregarTabela() {
    ...
    colunas, dados, criarAcoes(), null, null);
  ...
  private List < TabelaGerador.AcaoTabela > criarAcoes() {
    ...
    acoes.add(new TabelaGerador.AcaoTabela() {@Override
      public void executar(int linha, Object[] dadosLinha) {
        ...
        TabelaFaturaVisao.this, "Remover " + dadosLinha[1] + "?", "Confirmação", JOptionPane.YES_NO_OPTION);
        ...
        if (confirm == JOptionPane.YES_OPTION) {
          ...
          JOptionPane.showMessageDialog(TabelaFaturaVisao.this, "Removido!");
        }
      }
 ...
 */
  ...
  public static void main(String[] args) {
    SwingUtilities.invokeLater(() -> new TabelaFaturaVisao(0).setVisible(true));
  }
}