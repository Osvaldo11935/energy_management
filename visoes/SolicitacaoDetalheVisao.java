...
public class SolicitacaoDetalheVisao extends JPanel {
	private SolicitacaoModelo solicitacao;
	private JPanel painelRespostas;
	private JTextArea txtResposta;
	private JButton btnResponder;

	public SolicitacaoDetalheVisao(SolicitacaoModelo solicitacao) {
	...
	private void responder() {
		...
		resposta.setStatus(EstadoSolicitacaoEnum.RESPONDIDA.toString());
