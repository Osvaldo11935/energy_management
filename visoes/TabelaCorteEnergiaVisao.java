...
public class TabelaCorteEnergiaVisao extends JFrame {
  ...
  public TabelaCorteEnergiaVisao() {
  ...
  private void carregarTabela() {
    ...
    List <Object[]> dados = corteEnergias.stream().map(u -> new Object[] {
      u.getId(),
  ...
  public static void main(String[] args) {
    SwingUtilities.invokeLater(() -> new TabelaCorteEnergiaVisao().setVisible(true));
  }
}